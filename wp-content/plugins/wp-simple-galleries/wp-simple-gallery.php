...
class wpsimplegallery {
    ...
    public function inner_custom_box($post) {
        ...
        <input id="wpsg-plupload-browse-button" class="button" type="button" value="<?php echo __('快速上传', 'wpsimplegallery'); ?>" rel="" />
        <input id="wpsimplegallery_upload_button" data-uploader_title="Upload Image" data-uploader_button_text="Select" class="upload_button button" type="button" value="<?php echo __('上传图片', 'wpsimplegallery'); ?>" rel="" />
        <input id="wpsimplegallery_add_attachments_button" class="button" type="button" value="<?php echo __('添加所有附件', 'wpsimplegallery'); ?>" rel="" />
        <input id="wpsimplegallery_delete_all_button" class="button" type="button" value="<?php echo __('删除所有', 'wpsimplegallery'); ?>" rel="" />
